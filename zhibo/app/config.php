...
$configs = [
    ...
    // 注册的根命名空间
    'root_namespace'          => ['cmf' => CMF_PATH, 'plugins' => PLUGINS_PATH, 'themes' => PLUGINS_PATH . '../themes', 'api' => CMF_ROOT . 'api/','Faker' => VENDOR_PATH.'faker/v1.7.1/src/Faker'],
    // 扩展函数文件
    'extra_file_list'         => [CMF_PATH . 'common' . EXT, THINK_PATH . 'helper' . EXT,APP_PATH.'admin/function'.EXT,APP_PATH.'portal/function'.EXT],
    // 默认输出类型
    ...
    // +----------------------------------------------------------------------
    // | 生产模式下抛出HttpException异常
    // +----------------------------------------------------------------------
    'http_exception_template'    =>  [
        // 定义404错误的重定向页面地址
        404 =>  CMF_ROOT.'public/error.html',
        // 定义500服务器错误
        500 =>  CMF_PATH.'public/500.html',
    ]
];
