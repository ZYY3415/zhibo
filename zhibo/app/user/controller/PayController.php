...
class PayController extends HomeBaseController
{
    ...
    #入金异步回调
    private $notify_url = "http://api.hfb99.com/user/pay/notify.html";

    #入金成功页面
    protected $payinsuccess = "";

    //充值成功页面
    protected $chargesuccess = "http://api.hfb99.com/user/pay/userIndex.html";
    ...
    {
        return view('profile/paysuccess');
    }
