...
class PostService
{
    ...
    public function adminPostList($filter, $isPage = false)
    {
        ...
        $join = [
            ['__USER__ u', 'a.user_id = u.mid']
        ];

        $field = 'a.*,u.username,u.user_nickname,u.email';
        ...
        if (!empty($category)) {
            ...
            $field = 'a.*,b.id AS post_category_id,b.list_order,b.category_id,u.username,u.user_nickname,u.email';
        }
